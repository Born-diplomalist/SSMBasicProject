...
<head>
  <title>SSM后台管理员登录</title>
  <!-- 将该行放在head标签中，即可设置网页标题栏左侧的图标，防止出现GET http://localhost:8080/favicon.ico 404 (Not Found) -->
  <link rel="icon" href="../resources/admin/login/images/logo.ico" type="img/x-ico" />
...
<div id="particles-js">
		<div class="login" style="display: block;">
			...
			<div class="login-center clearfix">
				<div class="login-center-img"><img src="../resources/admin/login/images/password.png"></div>
				<div class="login-center-input">
					<input style="width:50%" id="cpacha" name="capche" type="text" name="" value="" placeholder="请输入验证码" onfocus="this.placeholder=&#39;&#39;" onblur="this.placeholder=&#39;请输入验证码&#39;">
					<div class="login-center-input-text">验证码</div>
					<img id="cpacha-img" title="点击切换验证码" style="cursor:pointer" src="get_cpacha?v1=4&w=100&h=30&type=loginCpacha" width="110px" height="30px" onclick="changeCpacha()">
				</div>
			</div>
...
<script type="text/javascript">
	...
	*/
	function changeCpacha(){
		$("#cpacha-img").attr("src","get_cpacha?v1=4&w=100&h=30&type=loginCpacha&t="+new Date().getTime());	
	}
	
	/*
	* 当登录按钮被点击时
	将登录所在表单的div激活,以加上一定的动画效果
	对参数做校验
	*/
	document.querySelector(".login-button").onclick = function(){
			...
			//将那个不停翻转的小白方块设为激活状态，并隐藏登录表单
			addClass(document.querySelector(".sk-rotating-plane"), "active");
			document.querySelector(".login").style.display = "none";
			//异步发送登录请求到控制层,注意post请求方式提交时参数不会拼接到URL上
			$.ajax({
				url:'login',
				...
				success:function(data){
					//登录成功跳转到指定页面，登录失败移除登录动画，显示登录表单，刷新验证码
